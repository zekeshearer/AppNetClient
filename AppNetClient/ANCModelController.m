...
@implementation ANCModelController
...
static ANCModelController *_instance = nil;
...
+ (ANCModelController *)instance
{
    ...
    dispatch_once(&onceToken, ^{
        _instance= [[ANCModelController alloc] init];
    });
    return _instance;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"AppNetClient" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"AppNetClient.sqlite"];
...
- (void)_contextDidSave:(NSNotification *)notification
{
    ...
    if ( ![NSThread isMainThread] ) {
        [self performSelectorOnMainThread:@selector(_contextDidSave:) withObject:notification waitUntilDone:YES];
        return;
    }
    @try {
